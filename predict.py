"""Neurox AI - Prediction interface for Cog / Replicate."""

from cog import BasePredictor, Input
from megatron.utils import setup_for_inference_or_eval
from megatron.text_generation_utils import generate_samples_from_prompt
from megatron.branding import prepend_system_prompt, apply_branding
...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        branded_prompt = prepend_system_prompt(prompt)
        ...
        if output and isinstance(output, list):
            return apply_branding(output[0].get("text", ""))
        return apply_branding(str(output))
